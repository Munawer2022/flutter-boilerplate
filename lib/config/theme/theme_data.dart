...
class AppThemes {
  ...
  Color _getColor(String key, {String fallbackColor = '#000000'}) {
    ...
    String hexColor = data != null && data['data']?[key] != null
        ? data['data']![key]
        : fallbackColor;
    try {
  ...
  ThemeData get lightTheme => ThemeData(
    ...
    secondaryHeaderColor: _getColor('app_secondary_color', fallbackColor: '#F53D3D'),
    disabledColor: _getColor('app_button_disable_color', fallbackColor: '#D81818'),
    scaffoldBackgroundColor: _getColor('app_splash_screen_bg_color', fallbackColor: '#FAFAFA'),
    cardColor: Colors.white,
    iconTheme: IconThemeData(color: _getColor('app_icon_color', fallbackColor: '#FF4747')),
    appBarTheme: AppBarTheme(
      backgroundColor: _getColor('app_primary_color', fallbackColor: '#2F8C1D'),
    ...
    buttonTheme: ButtonThemeData(
      buttonColor: _getColor('app_button_active_color', fallbackColor: '#F5870A'),
      disabledColor: _getColor('app_button_disable_color', fallbackColor: '#D81818'),
    ),
    textTheme: TextTheme(
